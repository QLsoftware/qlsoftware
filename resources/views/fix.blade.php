                            ...
                            <div class="left">
                                <form class="form-inline" role="form" enctype="multipart/form-data"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <li><b>房间号：</b></li>
                                        <li><input name="room" id="room" class="select" value="规范数字填写"
                                                   onfocus="if(this.value=='规范数字填写') this.value='';this.style.color='#333'; return true;"
                                                   onblur="if(this.value=='') this.value='规范数字填写'; this.style.color='#999'; return true;"
                                        ...
                                        <li><b>姓名：</b></li>
                                        <li><input name="name" id="name" class="select"/></li>
                                        <li><b>联系电话：</b></li>
                                        <li><input name="phone" id="phone" class="select" value="手机号"
                                                   onfocus="if(this.value=='手机号') this.value='';this.style.color='#333'; return true;"
                                                   onblur="if(this.value=='') this.value='手机号'; this.style.color='#999'; return true;"
                                                   style="color: rgb(153, 153, 153); "/></li>
                                    ...
                                    <div class="bottom">
                                        <button type="submit" class="input"
                                                style="font-size:15px; font-family:'微软雅黑'; cursor:pointer;">提交
                                        </button>
                                    ...
                                    <!-- Default panel contents -->
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($repairData as $data)
                                                <form action="{{ url('/fix/evaluate')}}"
                                                      method="post">{{--这里必须把表单放在foreach内，否则指向最后一个--}}
                                                {{ csrf_field() }}
                                                @php($i++)
                                                @php($detail = 'detail'.$i)
                                                                            ...
                                                                            <div class="panel panel-success">
                                                                                <div class="list-group-item active">
                                                                                    <h4 class="list-group-item-heading">
                                                                                        地点</h4>
                                                                                    <p class="list-group-item-text">
                                                                                        xq-lfh-mp:{{$data->re_xq.'-'.$data->re_lfh.'-'.$data->re_mph}}</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="panel panel-info">
                                                                                <div class="list-group-item active">
                                                                                    <h4 class="list-group-item-heading">
                                                                                        故障说明</h4>
                                                                                    <p class="list-group-item-text">
                                                                                        kind+detail:{{$data->re_kind.'-'.$data->re_remarks}}</p>
                                                                                </div>
                                                                            </div>
                                                                            <div class="panel panel-info">
                                                                                <div class="list-group-item active">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-footer">
                                                                                    <button type="submit"
                                                                                            ...
                                                                                            style="font-size:15px; font-family:'微软雅黑'; cursor:pointer;">
                                                                                        提交
                                                                                    </button>
                                                                                </div>
                                                                            </div>
