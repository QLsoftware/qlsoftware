        ...
        <table class="table">
            ...
            @foreach($repairData as $data)
                <tr>
                    ...
                    <td> {{$data->re_state}}</td>
                    <td> <a href=" {{  url( '/repairman/update',['id'=>$data->re_id])}}"><button type="button" class="btn btn-success">已处理</button></a>
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary btn-lg" style="font-size: 12px;" data-toggle="modal" data-target="#myModal">
                            详情
                        </button>
                        ...
                        <a href="{{url('/repairman/delete',['id'=>$data->re_id])}}">  <button type="button" class="btn btn-danger">清除</button> </a></td>
                </tr>
            @endforeach
        </table>
    </div>
