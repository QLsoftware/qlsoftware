...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="panel-heading"><h4>教师评估</h4></div>
                        ...
                        <table class="table table-bordered">
                            ...
                            @foreach($option as $option_1)
                                <tr>
                                    ...
                                    <th>
                                        <div class="dropdown">
                                            <button type="label" class="well well-sm" id="dropdownMenu1"
                                                    data-toggle="dropdown">--请选择操作--
                                                <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                                                {{--                                                        <li><a href="  {{ url('202.194.15.39') }}">进入问卷</a></li>--}}
                                                <li>
                                                    <form class = "pull-center" action="{{ url('/evaluate/jump')}}" method="post">
                                                        {{ csrf_field() }}
                                                ...
                                                <li>
                                                    ...
                                                    <form action="{{ url('/evaluate/yijian')}}" method="post">
                                                        {{ csrf_field() }}
                                                        <input type="hidden" name="xnxq" value={{$option_1['3']}}>
                                                        <input type="hidden" name="kch" value={{$option_1['0']}}>
                                                        <input type="hidden" name="jsh" value={{$option_1['4']}}>
